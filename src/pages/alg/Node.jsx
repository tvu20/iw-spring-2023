    ...
    <div className="alg-section alg-container" style={{ paddingTop: "30px" }}>
      ...
      <div className="alg-explanation">
        <p>
          ...
          <b>pitch node, velocity node, duration node, entry delay node,</b> and{" "}
          <b>universal state values</b>.
        </p>
        <h3>Universal State Values</h3>
        <ul>
          <li>
            <b>Current state: </b> Most recent values output by each of the four
            nodes. This information is accessibly both layer-wide and
            network-wide.
          </li>
          <li>
        ...
        <p>
          Layer entry delay is calculated at each metronome tick. This value is
          used to sync up the other three nodes, which will all run and output
          values at the exact moment according to the layer E. This allows notes
          to be played at variable, unpredictable times.
        </p>
        ...
        <p>
          Velocity represents how loud a note is played. Correlates to dynamics
          (volume).
        </p>
        <p style={{ marginBottom: "0px" }}>
        ...
        <ul>
          ...
          <li>
            <b>Pitch deviation (Pd):</b> Stores the number of steps between the
            previously played note and the current note. This value ranges from
            -12 to 12, representing a span of two octaves. Corresponds to the
            interval. This value is only accessible by the pitch node.
          </li>
        </ul>
        <p style={{ marginBottom: "0px" }}>
        ...
        <p>
          ...
          distribution. Finally, we add the calculated interval to this note to
          determine the final P output, and update layer entropy accordingly.
        </p>
      </div>
    </div>
  );
