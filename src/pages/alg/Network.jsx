    ...
    <div className="alg-section alg-container" style={{ paddingTop: "30px" }}>
      ...
      <FadeInSection>
        <div className="alg-explanation">
          ...
          <p>
            Each layer in the network is identified by its timbre as
            representing a particular instrument. Each layer contains some
            layer-specific state, which is widely accessible by all nodes at all
            times. There are interlayer connections between each of the layers
            in the system, which can be pruned as desired by the user.{" "}
          </p>
          <h3>Universal State Values</h3>
          <ul>
            <li>
              <b>Network entropy: </b> Describes the current entropy in the
              entire network. Calculated as the average entropy across all
              layers.
            </li>
            <li>
              <b>Universal metronome (ED): </b> Metronome for the entire
              iteration of the program. Set by the user before the program runs
              and is referenced by all layers.
            </li>
            <li>
