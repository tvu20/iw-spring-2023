    ...
    <div className="alg-section alg-container" style={{ paddingTop: "30px" }}>
      ...
      <div className="goals-container alg-item-container">
        <div className="goals-item auto-height alg-item">
          ...
          <p>
            In an ensemble, each instrument contributes a different musical tone
            and quality.{" "}
          </p>
          <p>
            In our algorithm, we construct a <b>series of node layers,</b> where
            each layer represents an individual member/instrument.
          </p>
        </div>
        <div className="goals-item auto-height alg-item">
          <a
          ...
          <h4>Entropy</h4>
          <p>
            The amount of disorder in the system. Each individual has an entropy
            level, and the entire network also has an overall entropy.
          </p>
          <p>
            A <b>hierarchy of instruments</b> is created, where entropy of each
            individual influenced by those above and below.{" "}
          </p>
          <p>
            The entropy of the system changes over time to reflect the amount of
            randomness in the notes generated!
          </p>
        </div>
        ...
        <div className="goals-item auto-height alg-item">
          <a
            ...
            rel="noreferrer"
          >
            <img src={rules} alt="Rules icons created by Freepik - Flaticon" />
          </a>
          <h4>Rules</h4>
          <p>
          ...
          <p>
            Some rules <b>cannot change:</b> instruments have diffirent physical
            constraints, and we can set initial musical guidelines (starting
            pitches, metronome tempo).
          </p>
          <p>
