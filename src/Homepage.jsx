      ...
      <FadeInSection>
        <div className="home-section flex-container">
          <div className="flex-item">
            <p>
              Musical ensemble improvisation is an incredibly complex,
              impressive, and unpredictable phenomenon. In such a performance,
              musicians pick up on existing dynamics within the group, follow a
              set of unspoken rules, and adapt over time to meet the needs of
              their fellow ensemble members.
            </p>
            <p>
              A significant amount of behavioral research has been done on the
              parallel between self-organization in non-human complex systems
              such as ant colonies or fish swarms and the process of musical
              improvisation. The common thread lies with the presence of
              emergent patterns, which occurs when a system is observed to have
              properties or interactions arising when observed at a high level
              that cannot be predicted by its individual parts.
            </p>
          </div>
        ...
        <div className="home-section flex-container">
          ...
          <div className="flex-item flex-item-custom">
            ...
            <p>
              ...
              improvisation and musical emergence would have a lot of
              implications for the artistic field: for example, new composition
              techniques could be developed through using swarm intelligence
              models to generate innovative and dynamic compositions, or can
              help budding musicians develop their musicality and artistic
              voice.
            </p>
          </div>
        </div>
        ...
        <div className="grid-container">
          ...
          <div className="grid-item">
            <p>
              ...
              evaluations compiled throughout this independent work process.
        ...
        <div style={{ width: "100%", marginBottom: "100px" }}>
          <div className="goals-container">
            <div className="button-item">
              ...
              <p>
                Take a look at the road so far - what's been researched
                previously in the fields of self-organization within musical
                improvisation and generative music.{" "}
              </p>
            </div>
            <div className="button-item">
              <Link to={`algorithm`}>
