    ...
    <div className="homepage-container fade-in">
      ...
      <div className="title-container">
        ...
        <p>
          ...
          for the artistic field: for example, new composition techniques could
          be developed through using swarm intelligence models to generate
        ...
        <p>
          Curate an experience for musicians and listeners to approach this
          media and gain a better understanding of the field — still allows for
          an interactive music experience that spreads awareness of this field
          of study so far!
        </p>
